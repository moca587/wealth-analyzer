...
- ⚠ Inside the navy hero the popover is **cut off**, because `.wealth-hero` clips its overflow (📷 `5.9-info-popover-clipped-in-hero`, G-30). Standard: a popover is never clipped by its container.
