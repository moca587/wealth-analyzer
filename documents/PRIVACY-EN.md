...
1. **Contact details and an accountable person.** Insert the company address, postal code, data-protection email address and website, and **name the individual accountable for data protection** (section 1). A compliance officer will not accept an onboarding pack whose privacy notice has no responsible person and no address in it.

2. **Confirm the corrections to the three documents that carried the version-1.0 claim.** Replacement text has been written for all three; what remains is to verify each is actually published. All three contradicted this notice and two of them are contractual:
