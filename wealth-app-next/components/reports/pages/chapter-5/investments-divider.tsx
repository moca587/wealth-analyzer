...
export function InvestmentsDivider({
  clientName,
  date,
  page,
  totalPages,
    ...
    <section className="report-page relative mx-auto h-[210mm] w-[297mm] overflow-hidden bg-white px-[11mm] pb-[13mm] pt-[8mm] text-[#30343b] shadow-xl print:shadow-none">
      ...
      <div className="mt-[22mm]">
        ...
        <p className="mt-4 max-w-[760px] text-[15px] leading-6 text-[#555d66]">
          How your money is invested: the policy that governs the portfolio,
          what you hold today, how efficiently it is allocated, and the
          framework used to balance risk against your goals.
        </p>
      </div>
