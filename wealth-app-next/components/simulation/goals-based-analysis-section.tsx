...
export function GoalsBasedAnalysisSection({
  plan,
}: Props) {
  /*
  ...
  const portfolioMean =
    portfolioParams.mean;

  const portfolioSigma =
    portfolioParams.sigma;
    ...
    <section className={sectionClass}>
      <div>
        ...
        <p className="mt-2 text-[12px] leading-5 text-[#64748b]">
          Goals-based analysis using
          per-asset-class capital market
          assumptions and a full
          correlation matrix for portfolio
          risk. These are the same
          return/risk assumptions used by
      ...
      <div className="mt-6">
        ...
        <p className="mt-2 text-[11px] leading-5 text-[#64748b]">
          Per-asset-class long-term
          arithmetic return and volatility
        ...
        <table className="w-full border-collapse text-left">
          ...
          <tbody>
            ...
            <tr className="bg-[#f8faff]">
              <td
                className={`${tdClass} font-bold text-[#16213e]`}
              >
                YOUR PORTFOLIO
              ...
              <td
                className={`${numberTdClass} font-bold text-[#16213e]`}
              >
                {totalInvested > 0
                  ? "100.0%"
                  : "—"}
      ...
      <p className="mt-4 text-[10px] leading-5 text-[#64748b]">
        Portfolio σ uses the full
        correlation matrix rather than a
        weighted average of individual
        asset-class volatilities, so
        diversification is reflected in
      ...
      <p className="mt-4 border-t border-[rgba(0,87,184,.08)] pt-4 text-[10px] leading-5 text-[#9ca3af]">
        ...
        hypothetical forward-looking
        inputs. Actual investment outcomes
        will differ.
      </p>
    </section>
  );
