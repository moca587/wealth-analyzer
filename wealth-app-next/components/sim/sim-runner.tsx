      ...
      {result && (
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {[
              { k: "Median (P50)", v: result.realFinal.p50, cls: "text-foreground" },
              { k: "P25",          v: result.realFinal.p25, cls: "text-muted-foreground" },
              { k: "P75",          v: result.realFinal.p75, cls: "text-muted-foreground" },
              { k: "P10 (worst)",  v: result.realFinal.p10, cls: "text-destructive" },
              { k: "P90 (best)",   v: result.realFinal.p90, cls: "text-emerald-600" }
            ].map((s) => (
              <Card key={s.k}>
