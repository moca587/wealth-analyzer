...
export function AssetAllocationDonut({
  ...
  const grouped = assets.reduce<Record<string, number>>((acc, asset) => {
    ...
    if (rawGroup.includes("cash") || rawGroup.includes("bank")) {
      group = "cash & banking";
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center text-center">
          {hoveredSlice ? (
            <div>
              ...
              <div className="mt-0.5 text-[13px] font-bold text-[#16213e]">
            ...
            <div>
              <div className="text-[13px] text-[#9ca3af]">Assets</div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#64748b]">{slice.label}</span>
              </div>
