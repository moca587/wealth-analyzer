...
export default function ResetPasswordPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    setLoading(false);
    if (error) {
      setError(friendlyAuthError(error.message) + " Your reset link may have expired — request a new one.");
      return;
    }
    router.push("/app");
    router.refresh();
  ...
  return (
    <div>
      <h1 className="font-display text-4xl leading-tight mb-2">Set a new password.</h1>
