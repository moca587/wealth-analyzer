    ...
    <div className="min-h-screen">
      ...
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-md">
        <div className="container flex h-16 items-center justify-between">
          ...
          >
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-accent to-accent-3 text-white shadow-md">
              W
            </span>
            Wealth Analyzer
          </Link>
      ...
      <section className="relative overflow-hidden pt-40 pb-24">
        ...
        <div className="container max-w-5xl text-center animate-fade-in">
          ...
          <h1 className="mb-6 text-5xl font-extrabold leading-[1.05] tracking-[-0.045em] md:text-7xl">
            {" "}
            Plan your wealth.
            <br />
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground leading-relaxed mb-10">
            Build a complete financial plan in your browser. Run 1,000+ Monte
            Carlo paths against your goals. See the probability of reaching each
            milestone — and what changes when markets don&apos;t cooperate.
          </p>
          {/* old buttons */}
          ...
          <p className="mt-6 text-xs text-muted-foreground">
            Free during beta · no credit card · your data lives in your account,
            not in our analytics
          </p>
        </div>
      </section>
      ...
      <section className="border-y border-border bg-card py-16">
        <div className="container grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={s.l}>
              <div className="mb-2 text-5xl font-extrabold leading-none tracking-[-0.04em] text-accent">
                {s.v}
              </div>
      ...
      <footer className="border-t border-border py-12 text-sm text-muted-foreground">
        ...
        <div className="container mt-4 text-xs">
          Educational planning tool. Wealth Analyzer does not provide
          investment, tax, or legal advice — tax figures are simplified
          estimates. Consult a licensed advisor and a tax professional before
          making decisions.
        </div>
      </footer>
    </div>
