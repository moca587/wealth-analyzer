...
html = html.replace(
    '<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500&display=swap" rel="stylesheet">',
...
html = html.replace("'DM Serif Display', serif",  "Georgia,'Times New Roman',serif")
html = html.replace('"DM Serif Display",serif',   "Georgia,'Times New Roman',serif")
html = html.replace("'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',system-ui,sans-serif", "-apple-system,BlinkMacSystemFont,'Segoe UI',system-ui,Arial,sans-serif")
